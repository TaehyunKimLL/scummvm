...
the next reader does not have to guess.
    ...
    python3 makemaps.py tools/korean/mi2kor  # just one
"""
import glob
import os
import re
...
# "hr" first: those are baked by tools/korean/bakecells.sh at exactly
...
def write_map(folder, gameid, title):
    ...
    lines.append("#")
    lines.append("# Generated by tools/korean/makemaps.py from the font files themselves.")
